                        ...
                        <table class="min-w-full table-auto">
                            ...
                            <thead class=" ">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 border-b border-gray-200 text-gray-800 text-left text-xs font-semibold uppercase tracking-wider">Nama Perusahaan</th>
                            ...
                            <tbody class="bg-white font-semibold tracking-wider ">
                                ...
                                @if (Auth::user()->role != 'admin' && Auth::user()->role != 'user')
                                        <tr>
                                            <td colspan="12">
                                                <button data-modal-target="approve_modal" data-modal-toggle="approve_modal" class="bg-orange text-white px-4 py-2 rounded mt-5" type="button">
                                                    Approve
                                                </button>
                                            </td>
                                        </tr>
