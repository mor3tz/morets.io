<x-app-layout>
    ...
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
          ...
          <p class="mt-2 text-lg leading-8 text-gray-600">Silahkan Hubungi Kami Dengan Mengisi Form Di Bawah ini.</p>
        </div>
        <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
          
          <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div class="sm:col-span-2">
              <label for="first-name" class="block text-medium font-semibold leading-6 text-gray-900">Nama</label>
              <div class="mt-2.5">
            ...
            <div class="sm:col-span-2">
              <label for="company" class="block text-medium font-semibold leading-6 text-gray-900">Perusahaan</label>
              <div class="mt-2.5">
            ...
            <div class="sm:col-span-2">
              <label for="email" class="block text-medium font-semibold leading-6 text-gray-900">Email</label>
              <div class="mt-2.5">
            ...
            <div class="sm:col-span-2">
              <label for="phone-number" class="block text-medium font-semibold leading-6 text-gray-900">Nomer Handphone</label>
            ...
            <div class="sm:col-span-2">
              <label for="message" class="block text-medium font-semibold leading-6 text-gray-900">Pesan</label>
              <div class="mt-2.5">
